...
// Solution avec un MTlongButton (à partir de la version v1.1.0)
...
/////////////////////////// Bouton départ ///////////////////////////////////
void troisPompes(void) // C'est un appui long
{
...
MTlongButton BoutonDepart(PIN_BOUTON_DEPART, TEMPS_ATTENTE_POUR_3_POMPES, troisPompes, departCourt);
